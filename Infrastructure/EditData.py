...
rooms_ix, bedrooms_ix, population_ix, household_ix = [list(GetData().columns).index(col) for col in ("total_rooms", "total_bedrooms", "population", "households")]

def AddExtraFeatures(X, add_bedrooms_per_room=True):
